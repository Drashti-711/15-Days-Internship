...
<?php if($businessexpo_testimonial_disabled == true) { ?>
	<div id="testimonial-selector-scroll" class="testimonial-wraper" style="background-image:url('<?php echo wpfrank_companion_plugin_url ?>/inc/businessexpo/img/testimonial/testimonial-bg.png');">
