...
function wpfrank_businessexpo_Customizer_selective_refresh_settings($wp_customize) {
	...
	// Slider
	$wp_customize->add_setting( 'businessexpo_slider_feature_text1',array(
		'default'			=> __('Fast Secure Payments','wpfrank-companion'),
		'sanitize_callback'	=> 'sanitize_text_field',
		'transport'			=> $selective_refresh,
	));	
	$wp_customize->add_control( 'businessexpo_slider_feature_text1',array(
		'label'			=> esc_html__( 'Feature Options', 'wpfrank-companion' ),
		'section'		=> 'businessexpo_main_theme_slider',
		'priority'		=> 7,
		'type'			=> 'text',
	));		
	
	$wp_customize->add_setting( 'businessexpo_slider_feature_text2',array(
		'default'			=> __('Premium Products','wpfrank-companion'),
		'sanitize_callback'	=> 'sanitize_text_field',
		'transport'			=> $selective_refresh,
	));	
	$wp_customize->add_control( 'businessexpo_slider_feature_text2',array(
		'section'		=> 'businessexpo_main_theme_slider',
		'priority'		=> 8,
		'type'			=> 'text',
	));	
	
	$wp_customize->add_setting( 'businessexpo_slider_feature_text3',array(
		'default'			=> __('Free & fast Delivery','wpfrank-companion'),
		'sanitize_callback'	=> 'sanitize_text_field',
		'transport'			=> $selective_refresh,
	));	
	$wp_customize->add_control( 'businessexpo_slider_feature_text3',array(
		'section'		=> 'businessexpo_main_theme_slider',
		'priority'		=> 9,
		'type'			=> 'text',
	));		
	...
	$wp_customize->add_setting( 'businessexpo_service_section_subtitle',array(
		'default'			=> __('Our Services','wpfrank-companion'),
		'sanitize_callback'	=> 'sanitize_text_field',
		'transport'			=> $selective_refresh,
	));	
	...
	$wp_customize->add_setting( 'businessexpo_testimonial_section_title',array(
		'default' => __('What our Client Say?','wpfrank-companion'),
		'sanitize_callback' => 'sanitize_text_field',
		'transport' => $selective_refresh,
	));	
	...
	$wp_customize->add_setting( 'businessexpo_blog_section_title',array(
		'default' => __('Latest News','wpfrank-companion'),
		'sanitize_callback' => 'sanitize_text_field',
		'transport' => $selective_refresh,
	));	
